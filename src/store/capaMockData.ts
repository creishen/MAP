...
export const MOCK_CAPA_ITEMS: CapaItem[] = [
  ...
  {
    id: 'CAPA-125',
    vesselName: 'MV Meridian Pioneer',
    vesselId: 'VESSEL-008',
    checklistId: 'INS-01',
    checklistItemTitle: 'DP-2 Position Reference Systems',
    title: 'Calibrate laser position sensor optical head',
    findingDescription: 'Laser sensor receiver optical window showing minor surface condensation during tropical rain test.',
    owner: 'Meridian Marine Technical Services',
    dueDate: '15 Nov 2026',
    status: 'Open',
    inspectorNotes: 'Noted during annual dynamic positioning trial in Darwin Harbour.',
    createdDate: '22 Sep 2026',
    evidences: [
      {
        id: 'EV-125',
        title: 'Fanbeam sensor diagnostic log',
        type: 'Document',
        fileName: 'fanbeam_calibration_darwin.pdf',
        fileSize: '1.4 MB',
        uploadedAt: '22 Sep 2026 16:30',
        uploadedBy: 'Inspector Marcus Vance',
      },
    ],
  },
  {
    id: 'CAPA-126',
    vesselName: 'MV Austral Horizon',
    vesselId: 'VESSEL-009',
    checklistId: 'INS-02',
    checklistItemTitle: 'Bridge Navigational Watch Alarm System (BNWAS)',
    title: 'Test reset button stage 2 audible buzzer in duty officer cabin',
    findingDescription: 'Secondary alarm tone volume low in officer cabin during harbour watch simulation.',
    owner: 'Austral Ocean Technical Ops',
    dueDate: '20 Nov 2026',
    status: 'Open',
    inspectorNotes: 'Recommend adjusting sounder db level and re-verifying prior to departure.',
    createdDate: '23 Sep 2026',
    evidences: [
      {
        id: 'EV-126',
        title: 'BNWAS audio survey checklist',
        type: 'Document',
        fileName: 'bnwas_sound_level_test.pdf',
        fileSize: '950 KB',
        uploadedAt: '23 Sep 2026 10:15',
        uploadedBy: 'Inspector Marcus Vance',
      },
    ],
  },
  {
    id: 'CAPA-127',
    vesselName: 'MV Oceanic Sentinel',
    vesselId: 'VESSEL-010',
    checklistId: 'INS-03',
    checklistItemTitle: 'Emergency Generator Auto-Start System',
    title: 'Replace secondary 24V starter battery bank',
    findingDescription: 'Emergency switchboard auto-start trial passed primary bank but secondary battery bank voltage sagged below 22V.',
    owner: 'Oceanic Horizon Technical Services',
    dueDate: '18 Nov 2026',
    status: 'Open',
    inspectorNotes: 'Batteries ordered from local supplier in Dampier.',
    createdDate: '24 Sep 2026',
    evidences: [
      {
        id: 'EV-127',
        title: 'Battery load test recording',
        type: 'Photo',
        fileName: 'battery_load_dampier.jpg',
        fileSize: '2.4 MB',
        uploadedAt: '24 Sep 2026 13:00',
        uploadedBy: 'Inspector Marcus Vance',
      },
    ],
  },
